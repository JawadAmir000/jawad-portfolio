...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Co-built Donna AI — a multimodal personal AI assistant on Claude Agent SDK, ElevenLabs voice, and HeyGen avatars, with proactive alerts across Slack, WhatsApp, and email.",
    highlights: [
      "Developed a multimodal personal AI assistant using the Claude Agent SDK, ElevenLabs voice, and HeyGen avatars — letting users interact with their data via voice, video, and text, with proactive alerts across Slack, WhatsApp, and email.",
      "Architected a multi-agent orchestration system on Python/Django and Azure AI Foundry to coordinate autonomous agents through an event-driven architecture.",
      "Engineered a secure integration framework connecting AI agents with communication platforms and data sources for real-time multimodal interactions.",
    ],
    technologies: [
      "Python",
      "Django",
    ...
    achievements: [
      { metric: "Multimodal", description: "Voice + video + text in one assistant" },
      { metric: "3+", description: "Communication platforms integrated" },
      { metric: "Event-driven", description: "Multi-agent orchestration architecture" },
    ],
  },
  {
    slug: "selise",
